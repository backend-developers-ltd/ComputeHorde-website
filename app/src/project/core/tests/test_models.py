...
@pytest.mark.django_db(transaction=True)
def test__job__output_url_expiration(settings, user, validator, communicator, authenticated, miner):
...
@pytest.mark.django_db(transaction=True)
def test__job__selecting_validator__failure__not_authorized(user, validator, communicator):
...
@pytest.mark.django_db(transaction=True)
def test__job__selecting_validator__success(user, validator, communicator, authenticated, miner):
...
@pytest.mark.django_db(transaction=True)
def test__job__selecting_validator__user_preference(user, validator, communicator, authenticated, miners):
...
@pytest.mark.django_db(transaction=True)
def test__job__selecting_miner__user_preference(user, validator, communicator, authenticated, miners):
